...
export function showToast(type: ToastType, message: string, options?: ShowToastOptions) {
  ...
  switch (type) {
    case 'success':
      toast.success(message, { description, duration, icon: icons.success });
      break;
    case 'error':
      toast.error(message, { description, duration, icon: icons.error });
      break;
    case 'warning':
      toast.warning(message, { description, duration, icon: icons.warning });
      break;
    case 'info':
      toast.info(message, { description, duration, icon: icons.info });
      break;
  }
}
