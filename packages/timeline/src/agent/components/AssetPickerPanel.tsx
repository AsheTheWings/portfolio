...
import { Card, CardHeader, CardTitle, CardDescription, CardContent, CardAction, Button } from '@portfolio/ui/components/shadcn';
import { Plus, ArrowLeft, Layers, CheckSquare, X } from 'lucide-react';
import { useAgent } from '../hooks/useAgent';
import { LibraryPicker, useLibraryStore, type Asset } from '@portfolio/timeline/library';
